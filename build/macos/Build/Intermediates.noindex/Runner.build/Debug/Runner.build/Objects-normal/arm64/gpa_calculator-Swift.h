...
#ifndef GPA_CALCULATOR_SWIFT_H
#define GPA_CALCULATOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="gpa_calculator",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14gpa_calculator11AppDelegate")
...
SWIFT_CLASS("_TtC14gpa_calculator17MainFlutterWindow")
